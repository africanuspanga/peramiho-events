...
const testimonials = [
  ...
  },
  {
    ...
    content: "They transformed our festival with incredible lighting and sound. The stage setup was world-class. PERAMIHO is our go-to for all major events.",
    rating: 5,
  },
  {
    name: "Kelvin Warioba",
    role: "Business Owner",
    content: "Outstanding service from start to finish. Their team understood our vision and delivered beyond expectations. Will definitely work with them again.",
    rating: 5,
  },
];
